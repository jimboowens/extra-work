...
?>
	...
	<script>window.onscroll=()=>{myFunction()};
	...
	<?php if ( $et_top_info_defined && ! $et_slide_header || is_customize_preview() ) : ?>
		...
		<div id="top-header"<?php echo $et_top_info_defined ? '' : 'style="display: none;"'; ?>>
			<div class="container clearfix">
				<div id="above-header-container">
					<div id="above-header-content">
			<h1><img class="alignnone wp-image-497 size-full" 
src="http://ninfas.com/wp-content/uploads/texas-line-1.png" style="padding-right: 8px; margin-bottom: -15px" alt="texas-line" width="80" height="58"/>THERE IS ONLY ONE ORIGINAL NINFA'S AND THIS IS IT.</h1>
		</div>	
	</div>

			<?php if ( $et_contact_info_defined ) : ?>
				
				<p align="right">Mon – Thu 11 am – 10 pm<br>
Fri 11 am – 11 pm<br>
Sat 10 am – 11 pm<br>
Sun 10 am – 10 pm<br></p>
